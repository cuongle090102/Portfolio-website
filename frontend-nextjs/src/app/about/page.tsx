  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-black dark:text-white page-transition transition-colors duration-300">
      ...
      <div className="absolute top-6 right-6 z-10">
        <span className="text-gray-900 dark:text-slate-100 text-sm font-medium relative">
          ABOUT
              ...
              <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl p-8 card-hover">
                <div className="flex flex-col md:flex-row md:items-start gap-6">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-16 h-16 bg-blue-50 dark:bg-blue-950 border border-blue-100 dark:border-blue-900 rounded-xl flex items-center justify-center">
                      <img
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
                      ...
                      <span className="text-sm text-gray-400 dark:text-slate-500 font-medium whitespace-nowrap">2020 — 2024</span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Data Structures & Algorithms', 'Machine Learning', 'Database Systems', 'Software Engineering', 'Computer Networks', 'Statistics'].map((course) => (
                        <span key={course} className="text-xs font-medium text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-950 border border-blue-100 dark:border-blue-900 px-3 py-1.5 rounded-full">
                          {course}
                        </span>
                      ))}
                    </div>
